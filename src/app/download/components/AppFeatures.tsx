...
const features = [
  ...
  },
  {
    icon: '📍',
    title: 'אימות מיקום',
    description: 'הצביעו רק על נושאים ברשות המקומית שלכם עם אימות GPS.',
  },
  {
    icon: '🔒',
    title: 'אבטחה מקסימלית',
    description: 'אימות רב-שכבתי מבטיח שהקול שלכם מאובטח ומאומת.',
  },
  {
    icon: '💰',
    title: 'טוקני Sync',
    description: 'צברו טוקנים עם כל הצבעה והפכו לחלק מהכלכלה הקהילתית.',
  },
  {
    icon: '📱',
    title: 'חוויה חלקה',
  ...
  },
  {
    icon: '🌐',
    title: 'שקיפות מלאה',
    description: 'כל הצבעה נרשמת על הבלוקצ׳יין ופתוחה לביקורת ציבורית.',
  },
];
