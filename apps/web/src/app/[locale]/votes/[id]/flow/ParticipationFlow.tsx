...
const COPY: Record<Locale, FlowCopy> = {
  he: {
    ...
    scoreGateResidency: 'אימות תושבוּת הוא תנאי חובה להצבעה - שום אימות אחר לא מחליף אותו.',
  ...
  en: {
    ...
    scoreGateResidency: 'Verified residency is a hard requirement of the ballot — no other verification substitutes for it.',
