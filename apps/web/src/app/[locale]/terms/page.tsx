    ...
    return {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'Paid actions are priced in Israeli New Shekels (ILS). Participating in a vote costs ₪3; creating a vote costs ₪50. Payments are processed by Green Invoice, which acts as the Merchant of Record for your purchase. Applicable taxes are calculated and collected by Green Invoice at checkout.',
  ...
  return {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'הפעולות בתשלום מתומחרות בשקלים חדשים (₪). השתתפות בהצבעה עולה ₪3; יצירת הצבעה עולה ₪50. התשלומים מעובדים על ידי Green Invoice, המשמשת כסוחר הרשום (Merchant of Record) עבור הרכישה. מסים רלוונטיים מחושבים ונגבים על ידי Green Invoice בעת התשלום.',
