...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 05-01-01 | 01 | 1 | SPACE-01, SPACE-04, SPACE-09 | unit/static | `grep -c "CREATE TABLE public.spaces\\|CREATE TABLE public.space_capability_grants\\|CREATE TABLE public.space_member_suspensions\\|CREATE TABLE public.space_audit_log\\|CREATE TABLE public.platform_escalations" supabase/migrations/20260802000010_space_governance.sql \| grep -qx 5 && grep -q "uq_spaces_municipality" supabase/migrations/20260802000010_space_governance.sql && grep -q "space_audit_log_no_truncate" supabase/migrations/20260802000010_space_governance.sql && ! grep -qE "ON DELETE CASCADE" supabase/migrations/20260802000010_space_governance.sql && echo MIGRATION_1_OK` | ✅ | ⬜ pending |
| 05-01-02 | 01 | 1 | SPACE-01, SPACE-04, SPACE-09 | unit/static | `test "$(grep -cvE '^\s*(--.*)?$' supabase/migrations/20260802000011_vote_status_review_values.sql)" = "4" && grep -q "idx_votes_review_queue" supabase/migrations/20260802000012_vote_review_gating.sql && ! grep -qE "in_review\|changes_requested\|rejected\|draft" <(grep -v '^\s*--' supabase/migrations/20260802000011_vote_status_review_values.sql \| grep -v 'ALTER TYPE') && echo ENUM_SPLIT_OK` | ✅ | ⬜ pending |
